...
public class actmenu extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "app.transfer.receive", "app.transfer.receive.actmenu");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "app.transfer.receive", "app.transfer.receive.actmenu");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "app.transfer.receive.actmenu", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 15;BA.debugLine="ToastMessageShow(\"از برنامه خارج شوید و فایلهایی که میخواهید منتقل شود را از طریق گزینه اشتراک به این برنامه بفرستید\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("از برنامه خارج شوید و فایلهایی که میخواهید منتقل شود را از طریق گزینه اشتراک به این برنامه بفرستید",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 16;BA.debugLine="Activity.Finish";
